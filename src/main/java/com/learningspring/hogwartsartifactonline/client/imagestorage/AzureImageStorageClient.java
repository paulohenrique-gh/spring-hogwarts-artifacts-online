package com.learningspring.hogwartsartifactonline.client.imagestorage;

import com.azure.storage.blob.BlobClient;
import com.azure.storage.blob.BlobContainerClient;
import com.azure.storage.blob.BlobServiceClient;
import com.azure.storage.blob.models.BlobStorageException;
import com.learningspring.hogwartsartifactonline.system.exception.CustomBlobStorageException;
...
public class AzureImageStorageClient implements ImageStorageClient{
    ...
    public String uploadImage(String containerName, String originalImageName, InputStream data, long length) throws IOException {
        try {
            ...
            // Get the BlobClient object to interact with the blob
